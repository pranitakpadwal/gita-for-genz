...
Arjuna opens this chapter with an honest question: is it better to worship you, Krishna, in your personal form, or to meditate on the formless, unmanifest absolute behind everything (12.1)?

Krishna's answer is direct, and a little surprising given how much of the earlier chapters spent time on abstract cosmic vision.

> **BG 12.5** *(paraphrased)*
>
> Those who fix their minds on the unmanifest, the formless, face greater difficulty, because it's harder for embodied beings to hold onto something with no shape at all.

The formless approach isn't wrong. It's just harder, especially for anyone still living in a body, in relationships, in specific days. Devotion to something with a form, someone you can actually address, argue with, show up for, is described as the more accessible path, not the lesser one.

Then Krishna spends the rest of the chapter describing, in detail, what that devotion actually looks like in practice, not as belief, but as behavior:

> **BG 12.13–14** *(paraphrased)*
>
...
The formless, abstract version of love, humanity in general, justice as a concept, "the world" as an idea, will never disagree with you, never ask you for anything you don't feel like giving, never sit with you through something uncomfortable. That's exactly why it's easier, and exactly why Krishna names it as the harder path in disguise. It feels advanced and philosophical. It's actually the version with the least accountability built in.
